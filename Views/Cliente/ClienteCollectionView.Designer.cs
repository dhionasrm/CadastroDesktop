namespace CadastroDesktop.Views.ClienteCollectionView {
    partial class ClienteCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "Cliente";
			// 
            // gridControl
            // 
			...
			this.clienteCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.clienteCollectionViewBindingSource.DataSource = typeof(CadastroDesktop.Modelo.Cliente);
			this.gridControl.DataSource = clienteCollectionViewBindingSource;
			...
			this.gridView.PopulateColumns(typeof(CadastroDesktop.Modelo.Cliente),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(CadastroDesktop.ViewModels.ClienteCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "ClienteCollectionView";
		...
		private System.Windows.Forms.BindingSource clienteCollectionViewBindingSource;
